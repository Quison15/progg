...
class SnakeGameAI:
    ...
    def play_step(self, action):
        ...
        # Uppdatera riktning och huvudposition baserat på åtgärden
        self._move(action)
        ...
        # Om spelet drar ut på tiden (förhindrar loopar)
...
class Agent:
    ...
    def __init__(self):
        self.n_games = 0
        self.epsilon = 0  # Bestämmer utforskningen (epsilon-greedy)
